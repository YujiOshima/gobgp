	...
	case api.Operation_ADD:
		...
		apitoConfig := func(a *api.Peer) config.Neighbor {
			...
			if a.ApplyPolicy != nil {
				if a.ApplyPolicy.Config != nil {
					pconf.ApplyPolicy.ApplyPolicyConfig.ImportPolicy = a.ApplyPolicy.Config.ImportPolicy
					pconf.ApplyPolicy.ApplyPolicyConfig.DefaultImportPolicy = config.DefaultPolicyType(a.ApplyPolicy.Config.DefaultImportPolicy)
					pconf.ApplyPolicy.ApplyPolicyConfig.ExportPolicy = a.ApplyPolicy.Config.ExportPolicy
					pconf.ApplyPolicy.ApplyPolicyConfig.DefaultExportPolicy = config.DefaultPolicyType(a.ApplyPolicy.Config.DefaultExportPolicy)
				}
			}
			return pconf
		}
